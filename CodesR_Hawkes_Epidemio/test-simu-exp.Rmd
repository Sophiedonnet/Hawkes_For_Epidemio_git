...
```{r}
Times = read.csv("simu_time_events.csv")[2]
...
#-------------------------- POSTERIOR inference
#---------------------------------------------------- 
part=seq(15000,30000,by=5)
L=length(part)
print(L)

lensim  = "T=30days"
absc=seq(0,5.0,len=100)
...
jumps <- jumps_integral(data$Times_utiles,h_med$s,10,32.5,h_med$smax)
